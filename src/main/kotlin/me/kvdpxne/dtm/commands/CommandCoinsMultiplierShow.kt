  ...
  return CommandBuilder.begin<Performer>("show")
    ...
    .handler { performer, parameters ->
      if (1 == parameters.size) {
        ...
        performer.prepareMessage(EnumTranslationKey.COMMAND_COINS_MULTIPLIER_SHOW_OTHERS)
          .format(
            Formatter.begin(2)
      ...
      performer.prepareMessage(EnumTranslationKey.COMMAND_COINS_MULTIPLIER_SHOW_SELF)
        .format(
          Formatter.begin(1)
            .with("VALUE", user.wallet.multiplier)
        )
